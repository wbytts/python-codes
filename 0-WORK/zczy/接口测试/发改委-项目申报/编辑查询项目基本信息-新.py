...
url = f"{dev_host}/zb-public/projectBaseNew/queryProjectBaseInfoByEdit"
...
res = requests.post(url, headers=headers, data=data, timeout=1000)
print(res.text)
